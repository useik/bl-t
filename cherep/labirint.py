...
final_sprite = GameSprite('final_sprite1.png', win_width - 85, win_height - 100, 80, 80)



monster1 = Enemy('pac_1.png', win_width - 80, 150, 80, 80, 5)

monster2 = Enemy('pac-1.png', win_width - 80, 230, 80, 80, 5)
...
#проверка, что игра еще не завершена
 ...
 if not finish:
     ...
     if sprite.collide_rect(packman, final_sprite):
         ...
         img = image.load('final_sprite1.png')
